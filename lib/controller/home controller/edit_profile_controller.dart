...
class EditProfileController extends GetxController {
  ...
  Future<void> editMode() async {
    ...
    selectedCaste.value = AppStorage.userData.value.caste ?? '';
    selectedSubCaste.value = AppStorage.userData.value.subCaste ?? '';

    // Marital status
    materialStatus.value = AppStorage.userData.value.maritalStatus ?? '';

    // Profile image (from Firestore/RealtimeDB)
    if (AppStorage.userData.value.profileImages != null &&
        AppStorage.userData.value.profileImages!.isNotEmpty) {
      profileImageUrl.value = AppStorage.userData.value.profileImages!.first;
    }
  ...
  //       final uploadedUrl = await firebaseServices.uploadFileToStorage(
  ...
  //       "religion": zipCodeCtrl.value.text.trim(),
  //       "caste": countryValue.value,
  //       "subCaste": stateValue.value,
  //       "maritalStatus": cityValue.value,
  //       "profileImages":
  //           profileImageUrl.value.isNotEmpty ? [profileImageUrl.value] : [],
